...
function Header() {
  ...
  return (
    <header className=" font-Nunito w-[100vw] h-[10vh] flex items-center justify-between px-5 bg-white">
      ...
      <div className="Navbtn w-[55vw] h-[10vh] flex items-center justify-between ">
